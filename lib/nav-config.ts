...
export const NAV_GROUPS: NavGroup[] = [
  ...
  },
  {
    ...
    items: [
      ...
      {
        href: '/ir/companies',
        labelAr: 'دليل الشركات',
        labelEn: 'Companies',
        icon: Briefcase,
        matchPrefixes: ['/ir/companies'],
      },
  ...
  },
  {
    ...
    items: [
      ...
      { href: '/tasks', labelAr: 'المهام الشاملة', labelEn: 'Tasks', icon: CheckSquare, matchPrefixes: ['/tasks'] },
    ],
  },
  {
    id: 'admin',
...
export const BREADCRUMB_LABELS: Record<string, string> = {
  ...
  organizations: 'المنظمات الدولية',
  companies: 'الشركات',
